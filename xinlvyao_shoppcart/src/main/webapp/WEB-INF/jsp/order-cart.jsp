...
<div class="w w1 header clearfix">
    <div id="logo"><a href="/"><img src="/images/ego-logo.gif" alt="京东商城" width="140" height="40"></a></div>
</div>
...
<form id="orderForm" class="hide" action="http://localhost:8086/order/create.html" method="post">
		...
		<input type="hidden" name="orderShipping.receiverName" value="SaiLing"/>
		<input type="hidden" name="orderShipping.receiverMobile" value="15891588888"/>
		<input type="hidden" name="orderShipping.receiverState" value="湖南"/>
		<input type="hidden" name="orderShipping.receiverCity" value="长沙"/>
		<input type="hidden" name="orderShipping.receiverDistrict" value="岳麓区"/>
		<input type="hidden" name="orderShipping.receiverAddress" value="岳麓大道 xxxxxxxxx"/>
		<input type="hidden" name="orderShipping.receiverZip" value="421001"/>
   			...
   			<ul class="ui-switchable-panel-main" id="consignee-list">
				...
				<li class="ui-switchable-panel" id="consignee_index_137617472"
					...
					<div class="consignee-item item-selected"
						...
						<div class="user-name">
							<div class="fl">
								<strong limit="4">SaiLing</strong>&nbsp;&nbsp;收
							</div>
							<div class="fr">158****8888</div>
							<div class="clr"></div>
						</div>
						<div class="mt10" limit="15">长沙 岳麓区</div>
						<div class="adr-m" limit="30">岳麓大道 xxxxxxxxx</div>
						<div>421001</div>
