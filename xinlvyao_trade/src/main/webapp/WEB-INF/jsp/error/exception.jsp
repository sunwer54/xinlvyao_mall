...
<meta name="viewport"
	content="width=device-width, initial-京东=1.0, minimum-京东=1.0, maximum-京东=1.0, user-scalable=no" />
<meta name="format-detection" content="telephone=no" />
...
<body id="mainframe">
	<div class="w w1 header clearfix">
		<div id="logo">
			<a href="/"><img src="/images/ego-logo.gif" alt="京东商城"></a>
		</div>
	</div>
...
#refresh .m .fore4 a {
	...
	font-size: 12px
			...
			<ul class="m">
				...
				<li class="fore2">返回<a href="http://localhost:8080/" target="_blank">京东首页</a></li>
